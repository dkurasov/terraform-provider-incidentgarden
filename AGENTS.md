...
- Format/test: `make fmt`, `make test`, `make check`.
...
- Acceptance tests require `TF_ACC=1`, a disposable organization, and explicit environment configuration. Never point them at production.
